...
delay(3000);
  ...
  for (int i=100;i>-100;i = i-10)//오른발앞로
  {
    lag1(i,280); 
    lag2(i,280);
    //lag5(i,280);
...
*/
for (int i=280;i<h;i = i+3)//오른발밑으로
  {
    lag1(-100,i); 
    lag2(-100,i);
    //lag5(-100,i);
  ...
  for (int i=100;i>-100;i = i-10)//왼발앞로
  {
    lag0(i,280); 
    lag3(i,280);
    //lag4(i,280);
  ...
  for (int i=-100;i<100;i = i+10)//오른발뒤로
  {
    lag1(i,h); 
    lag2(i,h); 
    //lag5(i,h); 
...
for (int i=-100;i<100;i = i+10)//왼발뒤로
  {
    lag0(i,h); 
    lag3(i,h); 
    //lag4(i,h); 
